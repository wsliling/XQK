			...
			<view class="top">
				...
				<view class="right">
					<view class="icon" @click="navigate('xingkongSon/explain')">
						<image src="http://xqk.wtvxin.com/images/wxapp/xingkong-icon/question.png" mode="widthFix">
						</image>
					</view>
					...
					<block v-if="roomData.IsVideo&&roomData.RoomNo&&roomData.Video">
						<view class="icon" @click="navigate('product/detail/videoPlay',{url:roomData.Video})">
							<image src="http://xqk.wtvxin.com/images/wxapp/xingkong-icon/camera.png" mode="widthFix">
							</image>
						</view>

	...
	var o, t, n, g = {
		...
		l = function(r) {
			return new Promise(function(t, n) {
				if (r.data = r.data || {}, r.data.v = "1.9.1", r.data.rqc = ++f, e = r.data, !(JSON
						.stringify(e).length <= g.maxRequestDataLength)) return f--, n(new Error(
					"invalid data"));
				var e;
				r.success = function(e) {
					...
					function t(n) {
						var r = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : g
							.requestRetryFirstDelay;
						return o.request({
							url: n.url,
							data: n.data,
							...
							fail: function(e) {
								n.data.rtc = (n.data.rtc || 0) + 1, n.data.rtc <= g
									.maxRequestRetryCount ? setTimeout(function() {
		...
		b = function() {
			return Promise.resolve().then(function() {
				...
				return i(e, "String") && 32 === e.length || (e = ([1e7] + 1e3 + 4e3 + 8e3 + 1e11).replace(
					/[018]/g,
					function(e) {
						return (e ^ ("undefined" != typeof crypto && crypto.getRandomValues ? crypto
							.getRandomValues(new Uint8Array(1))[0] : Math.floor(Math
							.random() * g.maxUint8)) & 15 >> e / 4).toString(16)
		...
		j = function() {
			return t || (p.sid = a(), p.rqc = 0, t = Promise.all([b(), new Promise(function(t) {
				...
				return new Promise(function(t) {
					o.getSetting({
						success: function(e) {
							e.authSetting && e.authSetting[
								"scope.userInfo"] ? o.getUserInfo({
									success: function(e) {
				...
				p.uuid = e[0], h.system = c(e[1]), h.network = c(e[2]), 0 < Object.keys(e[3]).length &&
					...
					Object.keys(e[5]).length && (h.userProperty = JSON.stringify(e[5])), h.system
					.platform
			}))
		},
		S = function() {
		...
		O = {
			...
			onShow: function() {
				...
				return h.aso.scene = "" + (t.scene || ""), t.referrerInfo && t.referrerInfo.appId ? h.aso
					.referrerInfo = t.referrerInfo : delete h.aso.referrerInfo, h.aso.path = t.path || "", h.aso
		...
		I = {
			...
			onShareAppMessage: function(e) {
				var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
					n = m(g.storageKeys.shareCount);
				n = (Number.isInteger(n) ? n : 0) + 1, v(g.storageKeys.shareCount, n);
				var r = {
					cnt: n,
					from: e.from,
					path: t.path
				...
				t.title && (r.title = "" + t.title), e.target && (r.target = JSON.stringify(e.target)), y(Object
					.assign({
						et: "share",
						en: "action",
						ep: r
				...
				var c, s, u, f, l = i.slice(Math.max(0, i.length - 3)).join("_");
				return t.path = (c = r.path, s = "mtj_shuuid", u = l, f = 0 < (c = c.replace(new RegExp(s +
						"=[^&]*", "g"), "").replace(/(\?|&)&/g, "$1").replace(/(\?|&)$/g, "")).indexOf(
					"?") ? "&" : "?", c + f + s + "=" + encodeURIComponent(u)), t
			},
					...
					if ("tap" !== e.type) {
						if ("touchmove" === e.type && e.touches instanceof Array) {
							...
							if (3 === e.touches.length) {
								if (w += 1, clearTimeout(k), 3 === w) return r.circleByThreeFingers = !0, r
									.circleToken = void 0, void y(Object.assign({
										et: "page",
										en: "show"
									}, h));
		...
		x = {
			...
			setUserInfo: function() {
				...
				return j().then(function() {
					var e = m(g.storageKeys.userInfo),
						t = i(e, "Object") ? e : {};
					s(n) && (t.tel = h.user.tel = n.substr(n.length - 11)), u(r) && (t.openId = h.user
						.openId = r), (t.tel || t.openId) && v(g.storageKeys.userInfo, t), i(n,
						"Undefined") || s(n) || console.error("手机号 ".concat(n, " 不合法")), i(r,
						"Undefined") || u(r) || console.error("openid ".concat(r, " 不合法"))
				}).catch(function(e) {
					d("setUserInfo", e)
				})
			},
			setUserId: function(o) {
				return Promise.resolve().then(function() {
					if (!(i(o, "String") || i(o, "Number") && Number.isFinite(o))) return Promise
						.reject(new Error("userId只能是字符串或数字"));
					var e = "" + o,
						t = m(g.storageKeys.userProperty),
						n = i(t, "Object") ? t : {};
					if (!n.uid_ || n.uid_[0] !== e) {
						n.uid_ = [e, "1"], v(g.storageKeys.userProperty, n), h.userProperty = JSON
							.stringify(n);
						var r = [{
							key: "uid",
							value: e
				...
				return Promise.resolve().then(function() {
					...
					Object.keys(o || {}).forEach(function(e) {
						...
						"" !== e && "_" !== e.charAt(0) && "_" !== e.charAt(e.length - 1) && (i(
								t, "Null") ? n[e] && (delete n[e], r--) : !(i(t,
								"String") || i(t, "Number") && Number.isFinite(t)) || e
							.length > g.maxUserPropertyKeyValueLength || ("" + t).length > g
							.maxUserPropertyKeyValueLength || !n[e] && r >= g
							.maxUserPropertyCount || (n[e] || r++, n[e] = [t, "1"]))
		...
		q = function(a) {
			g.enabledEvents.page.forEach(function(e) {
				...
				"function" == typeof a[e] && -1 === g.enabledEvents.page.indexOf(e) && -1 === g
					.enabledEvents.share.indexOf(e) && E(e, a, I.onAction)
			}), _(a)
		},
		K = function() {
			var e, t;
			...
			t && t.appKey ? (p.key = t.appKey, g.getLocation = t.getLocation || !1, g.disableCircling = t
				.disableCircling || !1, t.hasPlugin ? module.exports = {
					App: T,
					Page: q
